...
contract ERC1155ContractWithCert is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply, ERC1155URIStorage {
    ...
    constructor(string memory contractName, string memory contractSymbol, string memory contractURI, string memory contractCert)
        public
        ERC1155(contractURI)
    {
        name = contractName;
        symbol = contractSymbol;
		certificate = contractCert;
    }
